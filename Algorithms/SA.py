# -*- coding: utf-8 -*-
"""
Created on Tue Aug  2 16:39:48 2022
...
class SimulatedAnnealingBase():
    ...
    def __init__(self, func, n_dim, max_iter, lb, ub, T_max=100, T_min=1e-7, L=300, max_stay_counter=150, **kwargs):
        ...
        x0 = np.random.uniform(0, 1, size=(n_dim)) * (ub-lb) + lb
        self.n_dim = n_dim
...
class SimulatedAnnealingValue(SimulatedAnnealingBase):
    ...
    def __init__(self, func, n_dim, max_iter, lb, ub, T_max=100, T_min=1e-7, L=300, max_stay_counter=150, **kwargs):
        super().__init__(func, n_dim, max_iter, lb, ub, T_max, T_min, L, max_stay_counter, **kwargs)
