# -*- coding: utf-8 -*-
"""
Created on Tue Aug  2 15:38:18 2022
...
def MVO(func, n_dim, size_pop, max_iter, lb, ub):
    ...
    Universes = numpy.random.uniform(0, 1, size=(size_pop, n_dim)) * (ub-lb) + lb
    ...
    while Time < max_iter + 1:
        ...
        TDR = 1 - (math.pow(Time, 1 / 6) / math.pow(max_iter, 1 / 6))
        ...
        for i in range(0, size_pop):
            ...
            Inflation_rates[i] = func(Universes[i, :])
        ...
        for newindex in range(0, size_pop):
        ...
        x_best_hist.append(Best_universe)

        Time = Time + 1
        

    return x_best_hist, convergence